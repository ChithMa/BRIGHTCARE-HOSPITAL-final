        ...
        for (let i = 0; i < categorypath.length; i++) {
            ...
            <div class="product-container">
                ...
                <div class="quantity-selection">
                    ...
                    <input type="number" id="quantity-${i}-${j}" class="quantity-input" value="1" min="1">
                </div>
...
function addMedicineToCart(event) {
    ...
    // Extract the numeric price from "RS.xx.00"
    ...
    if (cartProducts[productName]) {
        ...
        cartProducts[productName].totalPrice += cartProducts[productName].price * cartProducts[productName].quantity;
    } else {
